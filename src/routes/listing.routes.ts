...
router.get('/admin/pending', listingController.getAdminPendingListings.bind(listingController));
router.patch('/:id/admin-status', listingController.updateListingStatusByAdmin.bind(listingController));
