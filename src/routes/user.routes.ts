...
router.get("/admin/pending-brokers", authMiddleware, userController.getPendingBrokers);
router.patch("/admin/approve-broker/:id", authMiddleware, userController.approveBroker);
